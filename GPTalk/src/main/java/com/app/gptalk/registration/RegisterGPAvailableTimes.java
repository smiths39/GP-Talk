...
public class RegisterGPAvailableTimes extends AsyncTask<Void, Void, String> {
    ...
    public RegisterGPAvailableTimes(Activity activity, HashMap<String, String> bookingTimeDetails) {
    ...
    protected void onPreExecute() {
        ...
        baseClass.initialiseProgressDialog(progressDialog, "Storing Booking Time Details...");
        super.onPreExecute();
    }
    ...
    private void storeBookingDetails() {
        ...
        try {
            url = new URI("http://www.gptalk.ie/WAMP/gcm_server_php/store_gp_available_time_details.php"
                    + "?booking_date=" + bookingDate
                    + "&booking_time=" + bookingTime
